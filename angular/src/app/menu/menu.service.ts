...
import { NewSourceComponent } from '../news/components/new-source/new-source.component';
class Menu {
  title: string;
  permission: string;
  ...
  this.menu = [
    ...
    },
    {
      title: "News", permission: News, menuItems: [
        ...
        // },
        {
          href: "Source", title: "Source", permission: News_Source, component: NewSourceComponent,
          active: false
        },
        {
